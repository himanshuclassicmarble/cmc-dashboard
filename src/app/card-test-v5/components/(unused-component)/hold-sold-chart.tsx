...
//             />
//             <span className="text-[10px] text-muted-foreground">Sold Qty:</span>
//           </div>
//           <span className="font-semibold text-[10px]">
//             {formatValue(data.value)}K
//           </span>
...
//             />
//             <Bar dataKey="sold" fill="var(--chart-1)" radius={[0, 0, 0, 0]}>
//               <LabelList
//                 dataKey="day"
...
//       (item) => item && item.day && typeof item.sold === "number",
//     );
//   }, [chartData]);
